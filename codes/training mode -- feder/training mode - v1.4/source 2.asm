...
##### PART 2 - BUTTON COMBOS FOR ITEMS #####
...
##### PART 4 - BUTTON COMBOS FOR BALL POSITION #####
# This is a new feature of version 1.4
lis r12, 0x8058			# Load 0x80585ee2, address of controller inputs
lhz r11, 0x5ee2 (r12)			# Load current inputs in r11 
lis r12, 0x806e
lwz r12, 0xFFFFf7a0	(r12)		# Load pointer of ball struct

andi. r0, r11, 0x2100 		# Check if 2 and Z pressed
cmpwi r0, 0x2100 			
bne+ DONT_WARP_BALL
# move ball position
lis r5, 0
stw r5, 0x21c (r12)
stw r5, 0x220 (r12)
# Check if D-pad left pressed, if so move ball into home's goal
lis r5, 0xc1b0
andi. r0, r11, 0x0001
bne- CHANGE_X
# Check if D-pad right pressed, if so move ball into away's goal
lis r5, 0x41b0
andi. r0, r11, 0x0002
bne- CHANGE_X
lis r5, 0
