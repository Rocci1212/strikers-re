...
This probably only works with textures that are located in the associated .rlt file though. (i.e. you cannot give luigi's texture to mario) never tried though.

### Second half - Some floats and some flags
The structure this varies from file to file and I don't understand how.  
The floats are texture transparency. For instance, setting the first float of mario.rlg to 0.5 (instead of 1.0) makes mario transparent  
